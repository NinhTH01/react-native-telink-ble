...
export enum BleEvent {
  ...
  EVENT_MESH_CONNECT_SUCCESS = 'EVENT_MESH_CONNECT_SUCCESS',

  EVENT_MESH_CONNECT_FAILED = 'EVENT_MESH_CONNECT_FAILED',

  EVENT_DEVICE_RESPONSE = 'EVENT_DEVICE_RESPONSE',

  EVENT_BLE_SDK_BUSY = 'EVENT_BLE_SDK_BUSY',

  EVENT_DEVICE_ON_OFF_STATUS = 'EVENT_DEVICE_ON_OFF_STATUS',

  EVENT_DEVICE_LIGHTNESS = 'EVENT_DEVICE_LIGHTNESS',

  EVENT_DEVICE_CTL = 'EVENT_DEVICE_CTL',

  EVENT_DEVICE_HSL = 'EVENT_DEVICE_HSL',
}
