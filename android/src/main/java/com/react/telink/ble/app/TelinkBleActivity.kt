package com.react.telink.ble.app
...
import com.react.telink.ble.SharedPreferenceHelper
import com.react.telink.ble.models.AppSettings
import com.react.telink.ble.models.MeshInfo
import com.react.telink.ble.models.UnitConvert
  ...
  private fun checkBluetooth() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
      ...
      val permission = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S)
        ...
        Manifest.permission.BLUETOOTH
      val sefPermission = ActivityCompat.checkSelfPermission(this, permission)
      if (sefPermission != PackageManager.PERMISSION_GRANTED) {
